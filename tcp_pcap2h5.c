/* Generated by Cython 0.19.1 on Thu Jan  9 18:22:13 2014 */
...
static char __pyx_k_64[] = "/home/deio/tcp_pcap2h5/tcp_pcap2h5.pyx";
 ...
 */
      ...
      (*((struct __pyx_t_11tcp_pcap2h5_tcp_packed *) ( /* dim=0 */ (__pyx_v_packet_view.data + __pyx_t_8 * __pyx_v_packet_view.strides[0]) ))).source_port = ntohs(__pyx_v_tcpHdr->source);
 ...
 */
      ...
      (*((struct __pyx_t_11tcp_pcap2h5_tcp_packed *) ( /* dim=0 */ (__pyx_v_packet_view.data + __pyx_t_9 * __pyx_v_packet_view.strides[0]) ))).dest_port = ntohs(__pyx_v_tcpHdr->dest);
 ...
 */
      __pyx_t_5 = PyInt_FromLong((__pyx_v_tcpHdr->doff << 2)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 131; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
 ...
 */
      ...
      (*((struct __pyx_t_11tcp_pcap2h5_tcp_packed *) ( /* dim=0 */ (__pyx_v_packet_view.data + __pyx_t_13 * __pyx_v_packet_view.strides[0]) ))).seq = ntohl(__pyx_v_tcpHdr->seq);
 ...
 */
      ...
      (*((struct __pyx_t_11tcp_pcap2h5_tcp_packed *) ( /* dim=0 */ (__pyx_v_packet_view.data + __pyx_t_14 * __pyx_v_packet_view.strides[0]) ))).ack = ntohl(__pyx_v_tcpHdr->ack_seq);
